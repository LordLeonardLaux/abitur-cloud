                                ...
                                <div className="flex items-center gap-2">
                                    {isEditMode && isEditingTitle ? (
                                        ...
                                        <h1
                                            ...
                                            className={cn("text-base md:text-lg font-bold truncate max-w-[150px] md:max-w-none", isEditMode && "cursor-pointer hover:text-blue-600")}
                                        >
                                            {title}
                                        </h1>
                                    )}
                ...
                <div className="flex-1 flex overflow-hidden relative">
                    ...
                    <div className="flex-1 min-h-0 bg-gray-50 relative flex flex-col overflow-hidden">
                        ...
                        <div className="flex-1 min-h-0 w-full overflow-hidden relative">
                            <PDFViewer url={pdfUrl} topicId={idParam || undefined} />
                        </div>
                    </div>
                </div>
            </main>
